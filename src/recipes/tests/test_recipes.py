...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user('test@londonappdev.com', 'testpass')
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user('other@londonappdev.com', 'password123')
    ...
    def test_create_recipe_with_tags(self):
        ...
        payload = {'title': 'Avocad lime cake', 'tags': [tag1.id, tag2.id], 'time_minutes': 60, 'price': 20.00}
        res = self.client.post(RECIPES_URL, payload)
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id=res.data['id'])
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='India Curry')
        tag1 = sample_tag(user=self.user, name='Vegan')
